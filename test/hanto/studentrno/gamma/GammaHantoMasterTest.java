...
package hanto.studentrno.gamma;
...
public class GammaHantoMasterTest
{
	...
	public void setup()
	{
		...
		redGame = factory.makeHantoGame(HantoGameID.GAMMA_HANTO, WHITE);
	}
	...
	@Test 		//19.2
	public void redWinsasSecoundPlayer() throws HantoException
	{
		redGame.makeMove(BUTTERFLY, null, makeCoordinate(0, 0));
		redGame.makeMove(BUTTERFLY, null, makeCoordinate(1, 0));
		redGame.makeMove(SPARROW, null, makeCoordinate(-1, 1));
		redGame.makeMove(SPARROW, null, makeCoordinate(1, 1));
		redGame.makeMove(SPARROW, makeCoordinate(-1, 1), makeCoordinate(0, 1));
		redGame.makeMove(SPARROW, null, makeCoordinate(2, -1));
		redGame.makeMove(SPARROW, null, makeCoordinate(0, -1));
		redGame.makeMove(SPARROW, null, makeCoordinate(2, 0));
		final MoveResult mr = redGame.makeMove(SPARROW, makeCoordinate(0, -1), makeCoordinate(1, -1));
		
		assertEquals(mr, MoveResult.WHITE_WINS);
	}
	
	@Test 		//19.1
	public void blueWinsAsSecoundPlayer() throws HantoException
	{
		MoveResult mr = null;
		for(int turns = 1; turns <= 6; turns++)
		{
			switch(turns)
			{
				case(1): redGame.makeMove(BUTTERFLY, null, makeCoordinate(0, 0)); break;
				case(2): redGame.makeMove(SPARROW, null, makeCoordinate(-1, 0)); break;
				case(3): redGame.makeMove(SPARROW, null, makeCoordinate(-1, 1)); break;
				case(4): redGame.makeMove(SPARROW, null, makeCoordinate(0, -1)); break;
				case(5): redGame.makeMove(SPARROW, null, makeCoordinate(1, -2)); break;
				case(6): redGame.makeMove(SPARROW, makeCoordinate(1, -2), makeCoordinate(1, -1)); break;
			}
			switch(turns)
			{
				case(1): redGame.makeMove(BUTTERFLY, null, makeCoordinate(1, 0)); break;
				case(2): redGame.makeMove(SPARROW, null, makeCoordinate(1, 1)); break;
				case(3): redGame.makeMove(SPARROW, null, makeCoordinate(1, 2)); break;
				case(4): redGame.makeMove(SPARROW, null, makeCoordinate(2, -1)); break;
				case(5): redGame.makeMove(SPARROW, null, makeCoordinate(0, 2)); break;
				case(6): mr = redGame.makeMove(SPARROW, makeCoordinate(0, 2), makeCoordinate(0, 1)); break;
			}
		}
	...
	{
		GammaHantoGame game1 = new GammaHantoGame(HantoPlayerColor.WHITE);
