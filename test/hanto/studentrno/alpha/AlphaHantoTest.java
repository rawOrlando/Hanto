...
package hanto.studentrno.alpha;
...
public class AlphaHantoTest
{
	...
	@Test(expected = HantoException.class)	// 3.5
	public void blueMovesToNonOriginOFF() throws HantoException
	{
	...
	@Test	// 9.1
	public void redButterflyIsAtCorrectPlaceAfterRedMovesNorth() throws HantoException
	{
		game.makeMove(HantoPieceType.BUTTERFLY, null, new TestHantoCoordinate(0, 0));
	...
	@Test	// 9.2
	public void redButterflyIsAtCorrectPlaceAfterRedMovesSouth() throws HantoException
	{
		game.makeMove(HantoPieceType.BUTTERFLY, null, new TestHantoCoordinate(0, 0));
		game.makeMove(BUTTERFLY, null, new TestHantoCoordinate(-1, 0));
		final HantoPiece butterfly = game.getPieceAt(new TestHantoCoordinate(-1, 0));
	...
	@Test	// 9.3
	public void redButterflyIsAtCorrectPlaceAfterRedMovesNorthEast() throws HantoException
	{
		game.makeMove(HantoPieceType.BUTTERFLY, null, new TestHantoCoordinate(0, 0));
		game.makeMove(BUTTERFLY, null, new TestHantoCoordinate(0, 1));
	...
	@Test	// 9.4
	public void redButterflyIsAtCorrectPlaceAfterRedMovesSouthWest() throws HantoException
	{
		game.makeMove(HantoPieceType.BUTTERFLY, null, new TestHantoCoordinate(0, 0));
		game.makeMove(BUTTERFLY, null, new TestHantoCoordinate(0, -1));
		final HantoPiece butterfly = game.getPieceAt(new TestHantoCoordinate(0, -1));
	...
	@Test	// 9.5
	public void redButterflyIsAtCorrectPlaceAfterRedMovesNorthWest() throws HantoException
	{
		game.makeMove(HantoPieceType.BUTTERFLY, null, new TestHantoCoordinate(0, 0));
		game.makeMove(BUTTERFLY, null, new TestHantoCoordinate(-1, 1));
		final HantoPiece butterfly = game.getPieceAt(new TestHantoCoordinate(-1, 1));
	...
	@Test //11
	public void printGiveNothing()
	{
		assertEquals(game.getPrintableBoard(), null);
	}
}
