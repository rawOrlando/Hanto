 ...
 * @version Mar 2, 2016
 */
public class HantoCordinateImpl implements HantoCoordinate
{
	 ...
	 */
	public HantoCordinateImpl(int x, int y) {
		this.x = x;
		this.y = y;
	}
	 ...
	 */
	public HantoCordinateImpl(HantoCoordinate coordinate)
	{
	...
	public boolean equals(Object obj)
	{
		...
		if (!(obj instanceof HantoCordinateImpl)) {
			return false;
		}
		final HantoCordinateImpl other = (HantoCordinateImpl) obj;
		if (x != other.x) {
			return false;
		}
		if (y != other.y) {
