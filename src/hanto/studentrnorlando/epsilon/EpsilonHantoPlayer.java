 ...
 *	March 28 2016
 */
public class EpsilonHantoPlayer extends GeneralHantoPlayer
{
	/**
	 * Constructor, sets up variable, and the color fo the player
	 * @param color Color of the Player
	 */
	public EpsilonHantoPlayer(HantoPlayerColor color)
	{
		super(color, 13);
		bag.addPiece(HantoPieceType.BUTTERFLY, 1);
		bag.addPiece(HantoPieceType.SPARROW, 2);
		bag.addPiece(HantoPieceType.CRAB, 6);
		bag.addPiece(HantoPieceType.HORSE, 4);
	}	
